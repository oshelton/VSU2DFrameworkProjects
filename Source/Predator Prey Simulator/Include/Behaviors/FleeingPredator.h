...
#ifndef FLEEINGPREDATOR_H_INCLUDED
#define FLEEINGPREDATOR_H_INCLUDED

#include "PredatorBehavior.h"

///Predator behavior for Predators that are avoiding Prey, such as when they have been spooked.
class FleeingPredator : public PredatorBehavior
{
public:
    ///Get the name of the PredatorBehavior.
    const std::string getName(){ return "Fleeing"; }
...
#endif // FLEEINGPREDATOR_H_INCLUDED
